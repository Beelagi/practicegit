...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -222, 284, 624));
        ...
        rs_232 = new QPushButton(scrollAreaWidgetContents);
        rs_232->setObjectName(QStringLiteral("rs_232"));
        rs_232->setStyleSheet(QStringLiteral(""));
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/audio/thank_you_audio_file/rs-232.png"), QSize(), QIcon::Normal, QIcon::Off);
        rs_232->setIcon(icon10);
        rs_232->setIconSize(QSize(40, 40));

        verticalLayout->addWidget(rs_232);
        ...
        QIcon icon11;
        icon11.addFile(QStringLiteral(":/audio/thank_you_audio_file/rs-485.png"), QSize(), QIcon::Normal, QIcon::Off);
        rs_485->setIcon(icon11);
        rs_485->setIconSize(QSize(30, 30));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        rs_232->setText(QApplication::translate("MainWindow", "RS 232", 0));
